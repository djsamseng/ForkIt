...
// ApiAI
#define COCOAPODS_POD_AVAILABLE_ApiAI
#define COCOAPODS_VERSION_MAJOR_ApiAI 0
#define COCOAPODS_VERSION_MINOR_ApiAI 0
#define COCOAPODS_VERSION_PATCH_ApiAI 1

// ApiAI/Default
#define COCOAPODS_POD_AVAILABLE_ApiAI_Default
#define COCOAPODS_VERSION_MAJOR_ApiAI_Default 0
#define COCOAPODS_VERSION_MINOR_ApiAI_Default 0
#define COCOAPODS_VERSION_PATCH_ApiAI_Default 1
